...
class ReviewAgent(
    ...
    async def run(self, **inputs: Any) -> dict[str, Any]:
        ...
        # Self-evolution: pull adaptive context (skills + memory) for the
        # review task before doing any LLM judging.  See §6.13 / §1.5.
        self._adaptive_review_context = self.build_adaptive_context(
            "review",
