...
# Ported from self-evolution branch — enables UnifiedSkillMatcher below.
...
# ─── Ported from self-evolution branch ───────────────────────────────────
# Bridges DEV's new skill system with main's legacy evolution/skills.py.
# Used by BaseResearchAgent.build_adaptive_context() and learn_from_trace().
